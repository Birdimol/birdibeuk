<div class='principal_avec_pub'>
    <form action='index.php?ctrl=outilsMJ&action=creation_simulation_combat' method='post'>
        <div class='cadreRouge' style="background-image:url('image/bg4.png');font-size:16px;width:900px;margin:auto;">
            <div style='text-align:center;'>Qui devront affronter vos aventuriers ?</div>
            <br>
        ...
        <br>
        <div style='text-align:center;'><input type='submit' value='Commencer le combat !' style='width:200px;'/></div>
    </form>
</div>
