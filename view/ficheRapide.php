<div class='principal_avec_pub'>
    ...
    <p>
        Dans cette rubrique, vous allez pouvoir encoder un aventurier sans aucun contrôle. 
        Si vous désirez créer un nouveau personnage, il est préférable d'utiliser la rubrique "<a href='index.php?ctrl=nouvelAventurier'>créer un nouvel aventurier</a>" 
        afin de s'assurer de respecter les règles.
    </p>
    <form method='post' action='index.php?ctrl=ficheRapide&action=action_creation'>    
    <div style='border-bottom:1px #900000 solid;text-align:center;cursor:pointer;' onclick='showDiv("divDonnees");'><h2 style='margin-bottom:0px;'>1: Données de l'aventurier</h2></div>
        ...
        <table class='default'>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php 
                        ...
                        {
                            echo "<option value='".$origine->ID."' >".$origine->nom."</option>";
                        }
                    ?>
                    </select>
                </td>                
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php 
                        ...
                        {
                            echo "<option value='".$metier->ID."' >".$metier->nom."</option>";
                        }
                    ?>
                    </select>
                </td>
            ...
            <tr><td><label for='ARGENT'>PIECES D'ARGENT</label></td><td><input type='text' id='ARGENT' value='0' name='ARGENT' /></td></tr>
            <tr><td><label for='CUIVRE'>PIECES DE CUIVRE</label></td><td><input type='text' id='CUIVRE' value='0' name='CUIVRE' /></td></tr>
            <tr><td><label for='PR'>PR</label></td><td><input type='text' id='PR' value='0' name='PR' /></td></tr>
            <tr><td><label for='PR_MAX'>PR MAX</label></td><td><input type='text' id='PR_MAX' value='0' name='PR_MAX' /></td></tr>
            <tr>
                <td><label for='codeacces'>CODE D'ACCÈS À LA FICHE</label></td>
                <td>
                    <input type='text' id='codeacces' value='' name='codeacces' />
            ...
            <tr>
                <td>
                    <?php                        
                        ...
                        {
                            echo "<div><input id='competence".$competence->ID."' type='checkbox' name='competence".$competence->ID."' />".$competence->NOM."</div>";
                            $compte++;
                            if($compte > 9)
                            {
                                echo "</td><td>";
                ...
                <td style='vertical-align:top;'>
                    ...
                    <table style='width:800px;background-image:url("image/bg3.png");border: 1px #900000 solid;'>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='text' size='2' id='PONouvelProt'/> 
                            </td>
                            <td>                                
    ...
    <br>
    <div style='text-align:center;cursor:pointer;' onclick='showDiv("fiche");'><h2>Ficher de personnage actuelle</h2></div>
